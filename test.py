...
def load_models():
    ...
    net.eval()
    net.load_state_dict(torch.load('./weights/vgg/dsfd.pth'))
...
if __name__ == '__main__':
    ...
    print(f'range: [{sys.argv[1]}, {sys.argv[2]}] of {len(img_list)}')
    img_list = img_list[int(sys.argv[1]) : int(sys.argv[2])]
